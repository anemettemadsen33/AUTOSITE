...
import { getVehicles, type VehicleFilterValues, type Vehicle } from '@/lib/vehicles';
        ...
        <>
          <div className="mb-6">
            <p className="text-gray-600 dark:text-gray-400">
              {totalCount} {totalCount === 1 ? t('vehicleFound') : t('vehiclesFound')}
            </p>
          </div>
